---
title: SpringBoot + Vue 开发前后端分离的旅游管理系统_soringboot+vue外键-CSDN博客
updated: 2026-06-07 10:55:52Z
created: 2026-06-07 10:37:06Z
source: https://blog.csdn.net/weixin_43734095/article/details/106959586
---
...
原创 于 2020-06-26 00:24:05 发布 · 9.2k 阅读

本文介绍了一个基于SpringBoot和Vue的旅游管理系统项目，涵盖了需求分析、数据库设计、前后端分离技术及功能实现，如验证码、分页、日期处理和文件上传。
...
- - [项目演示](#_29)
    - [数据库建表](#_46)
- [环境搭建](#_92)
- - [引入依赖（pom.xml）](#pomxml_95)
    - [配置文件（application.properties）](#applicationproperties_194)
- [href="javascript:;" 含义](#hrefjavascript__218)
- [select - option 绑定 Vue 实例](#select__option__Vue__227)
- [删除时增加确认选项](#_238)
- [Vue 获取地址栏跳转的参数](#Vue__245)
- [前后端分离项目—验证码功能](#_255)
- [前后端分离项目—分页功能](#_556)
- [前后端分离项目—日期数据类型的处理](#_675)
- [前后端分离项目—文件上传](#_697)
...
### <a id="t2"></a><a id="_29"></a>项目演示

进入系统需登录：  
<img width="962" height="526" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190754190.png"/>  
用户注册页面：  
<img width="962" height="544" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190746824.png"/>  
省份列表页面：  
<img width="962" height="526" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190736894.png"/>  
添加省份页面：  
<img width="962" height="544" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190724719.png"/>  
修改省份页面：  
<img width="962" height="526" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190715408.png"/>  
景点列表页面：  
<img width="962" height="544" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190708427.png"/>  
添加景点页面：  
<img width="962" height="544" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190700287.png"/>  
修改景点页面：  
<img width="962" height="544" src="https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190650082.png"/>

### <a id="t3"></a><a id="_46"></a>数据库建表
...
## <a id="t4"></a><a id="_92"></a>环境搭建

利用 **Spring Initializr** 快速搭建 SpringBoot 项目。

### <a id="t5"></a><a id="pomxml_95"></a>引入依赖（pom.xml）
...
### <a id="t6"></a><a id="applicationproperties_194"></a>配置文件（application.properties）
...
## <a id="t7"></a><a id="hrefjavascript__218"></a>href=“ javascript :;” 含义
...
## <a id="t8"></a><a id="select__option__Vue__227"></a>select - option 绑定 Vue 实例
...
## <a id="t9"></a><a id="_238"></a>删除时增加确认选项
...
![在这里插入图片描述](https://cdn.jsdelivr.net/gh/wumin198812/pic/img/20260607190437194.png)

## <a id="t10"></a><a id="Vue__245"></a>Vue 获取地址栏跳转的参数
...
## <a id="t11"></a><a id="_255"></a>前后端分离 项目—验证码功能
...
后台 控制器：需要对生成的验证码图片进行 Base64 编码后传到 前端 页面，前端再解析展示图片。
...
## <a id="t12"></a><a id="_556"></a>前后端分离项目—分页功能
...
## <a id="t13"></a><a id="_675"></a>前后端分离项目—日期数据类型的处理
...
## <a id="t14"></a><a id="_697"></a>前后端分离项目—文件上传
